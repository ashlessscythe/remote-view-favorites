...
2. In the small **Default surface** list on the left, click the pin next to a surface.
3. Exit Remote View, move wherever you like, and press TAB again.
4. Remote View opens on the pinned surface.
